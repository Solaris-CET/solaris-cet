...
export default function ProductsSection() {
  const productImages: Record<string, { src: string; alt: string; width: number; height: number }> = {
    'pv-res': {
      src: UNSPLASH('photo-1545209463-e2825498edbf'),
      alt: 'Panouri fotovoltaice pe acoperiș rezidențial — Solaris CET',
      width: 1600,
      height: 1000,
    },
    'pv-casa-verde': {
      src: UNSPLASH('photo-1509391366360-2e959784a276'),
      alt: 'Sistem fotovoltaic Casa Verde — montaj rezidențial Solaris CET',
      width: 1600,
      height: 1000,
    },
    'pv-3ph': {
      src: UNSPLASH('photo-1559302504-64aae6ca6b6d'),
      alt: 'Sistem fotovoltaic trifazat — instalare profesională',
      width: 1600,
      height: 1000,
    },
    'pv-hybrid': {
      src: UNSPLASH('photo-1518770660439-4636190af475'),
      alt: 'Sistem hibrid cu invertor și baterie — Solaris CET',
      width: 1600,
      height: 1000,
    },
    ev: {
      src: UNSPLASH('photo-1518770660439-4636190af475'),
      alt: 'Încărcător EV cu prioritizare solară — integrare în tabloul electric',
      width: 1600,
      height: 1000,
    },
    'pv-industrial': {
      src: UNSPLASH('photo-1497435334941-8c899ee9e8e9'),
      alt: 'Sistem fotovoltaic industrial — parc de panouri pe hală',
      width: 1600,
      height: 1000,
    },
    tpo: {
      src: UNSPLASH('photo-1611365892117-00ac5ef43c90'),
      alt: 'Acoperiș industrial cu membrană TPO și panouri fotovoltaice',
      width: 1600,
      height: 1000,
    },
    'tpo-inspect': {
      src: UNSPLASH('photo-1626885930974-4b69aa21bbf9'),
      alt: 'Inspecție acoperiș TPO — echipă tehnică pe teren',
      width: 1600,
      height: 1000,
    },
    roof: {
      src: UNSPLASH('photo-1559302504-64aae6ca6b6d'),
      alt: 'Acoperiș din tablă click — execuție și detalii profesionale',
      width: 1600,
      height: 1000,
    },
    service: {
      src: UNSPLASH('photo-1626885930974-4b69aa21bbf9'),
      alt: 'Mentenanță și verificare sistem fotovoltaic — echipă Solaris CET',
      width: 1600,
      height: 1000,
    },
  };
