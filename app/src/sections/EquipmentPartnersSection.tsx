    ...
    () => [
      {
        ...
        img: 'https://images.unsplash.com/photo-1545209463-e2825498edbf?w=1200&q=80&auto=format&fit=crop',
      ...
      },
      {
        ...
        alt: 'Invertor fotovoltaic și baterie LiFePO4 cu monitorizare',
      },
      {
        title: 'Baterie',
        subtitle: 'Autoconsum',
        img: 'https://images.unsplash.com/photo-1611365892117-00ac5ef43c90?w=1200&q=80&auto=format&fit=crop',
        alt: 'Sistem de stocare energie cu baterie și invertor hibrid',
      },
    ],
    [],
  );
