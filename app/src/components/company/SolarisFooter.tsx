          ...
          <div>
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="grid gap-2 sm:grid-cols-2">
                ...
                >
                  Calculator solar <ArrowRight className="h-4 w-4" aria-hidden />
                </a>
                <a
                  href={localizePathname('/survey', urlLocale)}
                  className="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-amber-400/25 bg-amber-400/10 px-5 py-3 text-sm font-black text-amber-200 hover:bg-amber-400/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/60"
                >
                  Survey șantier <ArrowRight className="h-4 w-4" aria-hidden />
                </a>
              </div>
            </div>
          </div>
