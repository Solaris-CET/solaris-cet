...
export default function GDPR() {
  return (
    <>
      <Helmet>
        <title>Politică de Confidențialitate — Solaris CET</title>
        <meta name="description" content="Politica de confidențialitate a Solaris CET. Află cum colectăm, utilizăm și protejăm datele tale personale." />
      </Helmet>
