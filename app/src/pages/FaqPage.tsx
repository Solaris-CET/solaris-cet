...
const FAQ_HIGHLIGHT_CONFIG = {
  kind: 'limited' as const,
  allowedTags: ['mark', 'strong', 'em'],
  allowedAttributes: ['class'],
};

const FAQ_ANSWER_CONFIG = {
  kind: 'limited' as const,
  allowedTags: ['strong', 'ul', 'li', 'br'],
  allowedAttributes: ['class'],
};
                    ...
                    {items.map((item) => {
                      ...
                      return (
                        <div key={item.question} className="rounded-2xl border border-white/10 bg-black/20">
                          ...
                          >
                            <SafeHtml as="span" html={highlightedQuestion} config={FAQ_HIGHLIGHT_CONFIG} />
                            {isOpen ? (
                          ...
                          {isOpen && (
                            <SafeHtml
                              html={renderAnswer(item.answer)}
                              config={FAQ_ANSWER_CONFIG}
