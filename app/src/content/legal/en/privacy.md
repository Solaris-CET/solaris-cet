...
- **Contract / steps prior to contract** (Art. 6(1)(b)) — providing requested features.
...
- **Strictly necessary** storage for core functionality (cannot be disabled).
- **Analytics** to understand aggregated usage (optional).
- **Marketing** to measure campaigns and retarget (optional).

You can manage your choices at any time via the Cookie Settings page.

## 6. Sharing and disclosures

We may share data with:

- **Service providers** (hosting, analytics, email delivery, security tooling) acting as processors.
...
If data is processed outside the EEA/UK, we use appropriate safeguards (e.g. SCCs) where required and assess transfer risks.
...
Retention periods may vary by data type. Where possible, we aggregate or delete data when it is no longer needed.
...
We may update this Policy. The “last updated” date indicates the latest revision. Material changes will be announced via the Service and, where appropriate, by email.
