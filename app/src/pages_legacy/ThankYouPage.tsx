  ...
  return (
    <main id="main-content" tabIndex={-1} className="pt-24 pb-0 bg-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 xl:px-12">
        <section className="rounded-3xl border border-white/10 bg-black/30 p-8 sm:p-12" data-reveal-stagger>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4" data-reveal-stagger>
            {[
