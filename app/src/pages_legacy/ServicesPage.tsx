...
function ServiceCardItem({ card }: { card: ServiceCard }) {
  ...
  const surveyHref = card.contactParam === 'fotovoltaice' ? '/survey' : null;
    ...
    >
      ...
      <div className="mt-6 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          {surveyHref ? (
            <a href={surveyHref} className="text-sm font-semibold text-emerald-300/80 hover:text-emerald-200">
              Survey șantier
            </a>
          ) : null}
